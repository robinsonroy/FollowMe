 ...
 * <b>Activité permettant de modifier le nom d'un utilisateur</b>
 *  @author Robinson
 *  @version 1.0
 */
public class ModifyUserActivity extends Activity implements View.OnClickListener{
     ...
     *  Affiche EditText du nom de l'utilisateur
     *
    ...
    private void ShowRoomsSettings(){
        Intent I = new Intent(ModifyUserActivity.this, RoomSettingsActivity.class);
        startActivity(I);
    }
    ...
    private void showSpeakersSettings() {
        Intent I = new Intent(ModifyUserActivity.this, SpeakersSettingsActivity.class);
        startActivity(I);
    }
    ...
    private void showDoorsSettings() {
        Intent I = new Intent(ModifyUserActivity.this, DoorsSettingsActivity.class);
        startActivity(I);
    }
